...
//매개변수로 받아온 값은 num에 저장하고 num~50까지중 3의 배수를 출력하는 메소드 numPrint1(int num)과 num~100까지 숫자 중 
//5와 7의 공배수를 출력하는 메소드 numPrint2(int num)를 구현하세요. 
